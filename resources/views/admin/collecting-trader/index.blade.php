...
<h3>Pengepul</h3>
@endslot
<li class="breadcrumb-item">Pengepul</li>

@slot('action')
<li><a href="#" onclick="openForm('{{ url('/pengepul/create') }}', 'create')"><i data-feather="plus"></i><span
    ...
    $(document).ready(function () {
        dt = $("#datatable").DataTable({
            ...
            columns: [
                    ...
                    {data: 'lokasi_distribusi', name: 'lokasi_distribusi'},
