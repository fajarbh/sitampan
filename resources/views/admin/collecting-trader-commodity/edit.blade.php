<form class="theme-form" id="edit-form" onsubmit="return false;" data-target="{{ url('komoditas-pengepul/update/'.$data->id) }}">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input class="form-control numeric comma" id="harga" name="harga" type="text" value="{{ number_format($data->harga,0,'','.') }}" />
    </div>
