...
@section('title', 'Lokasi Komoditas')
...
<h3>Lokasi Komoditas</h3>
@endslot
<li class="breadcrumb-item">Lokasi Komoditas</li>

@slot('action')
<li><a href="#" onclick="openForm('{{ url('/lokasi-komoditas/create') }}', 'create')"><i data-feather="plus"></i><span
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="display">
                            <thead>
                                <tr>
                                    <th width="10%">#</th>
                                    <th>Longitude Komoditas</th>
                                    <th>Latitude Komoditas</th>
...
<script>
    var dt;
    var API_URL = "{{ url('/lokasi-komoditas/api') }}";
    ...
    $(document).ready(function () {
        dt = $("#datatable").DataTable({
            ...
            columns: [
                ...
                {data: 'long_komoditas',name: 'long_komoditas'},
                {data: 'lat_komoditas',name: 'lat_komoditas'},
        ...
        $(document).on("submit", "#create-form", function () {
            $.ajax({
                url: "{{ url('/lokasi-komoditas/store') }}",
                type: "POST",
