...
@slot('action')
<li><a href="#" onclick="openForm('{{ url('/komoditas/create') }}', 'create')"><i data-feather="plus"></i><span
    ...
    $(document).ready(function () {
        dt = $("#datatable").DataTable({
            ...
            columns: [
                    ...
                    {data: 'jenis_komoditas', name: 'jenis_komoditas'},
                    {data: 'icon', name: 'icon'},
