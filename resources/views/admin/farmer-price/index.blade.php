...
@section('title', 'Harga Kelompok Petani')
...
<h3>Harga Kelompok Petani</h3>
@endslot
<li class="breadcrumb-item">Harga Kelompok Petani</li>

@slot('action')
<li><a href="#" onclick="openForm('{{ url('/harga-petani/create') }}', 'create')"><i data-feather="plus"></i><span
...
<script>
    var dt;
    var API_URL = "{{ url('/harga-petani/api') }}";
