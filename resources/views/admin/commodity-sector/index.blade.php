...
<h3>Jenis Komoditas</h3>
@endslot
<li class="breadcrumb-item">Jenis Komoditas</li>

@slot('action')
<li><a href="#" onclick="openForm('{{ url('/jenis-komoditas/create') }}', 'create')"><i data-feather="plus"></i><span
...
<script>
    var dt;
    var API_URL = "{{ url('/jenis-komoditas/api') }}";
