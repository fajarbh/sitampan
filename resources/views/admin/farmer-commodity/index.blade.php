...
@section('title', 'Komoditas Petani')
...
<h3>Komoditas Petani</h3>
@endslot
<li class="breadcrumb-item">Komoditas Petani</li>

@slot('action')
<li><a href="#" onclick="openForm('{{ url('/komoditas-petani/create') }}', 'create')"><i data-feather="plus"></i><span
...
<script>
    var dt;
    var API_URL = "{{ url('/komoditas-petani/api') }}";
    ...
    $(document).ready(function () {
        ...
        $(document).on("submit", "#create-form", function () {
            $.ajax({
                url: "{{ url('/komoditas-petani/store') }}",
                type: "POST",
