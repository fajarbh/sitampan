...
@section('title', 'Pendaftaran Penyuluh')
...
<h3>Pendaftaran Penyuluh</h3>
@endslot
<li class="breadcrumb-item">Pendaftaran Penyuluh</li>

@slot('action')
<li><a href="#" onclick="openForm('{{ url('/pendaftaran-penyuluh/create') }}', 'create')"><i data-feather="plus"></i><span
...
<script>
    var dt;
    var API_URL = "{{ url('/pendaftaran-penyuluh/api') }}";
    ...
    $(document).ready(function () {
        ...
        $(document).on("submit", "#create-form", function () {
            $.ajax({
                url: "{{ url('/pendaftaran-penyuluh/store') }}",
                type: "POST",
